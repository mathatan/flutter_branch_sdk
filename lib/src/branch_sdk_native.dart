...
class FlutterBranchSdkNative implements FlutterBranchSdkAbstract {
  ...
  static FlutterBranchSdkNative? _singleton;

  /// Constructs a singleton instance of [FlutterBranchSdkNative].
  factory FlutterBranchSdkNative() {
    if (_singleton == null) {
      _singleton = FlutterBranchSdkNative._();
    }
    return _singleton!;
  }

  FlutterBranchSdkNative._();
